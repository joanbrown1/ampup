...
import Failed from '../components/CustomerCare/Failed';
import Disco from '../components/CustomerCare/Disco';
import Announcements from '../components/CustomerCare/Announcements';
...
const AdminFailed = withIdleTimer(Failed);
const AdminDisco = withIdleTimer(Disco);
const AdminAnnouncement = withIdleTimer(Announcements);
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/admin/failed" element={<AdminFailed />} />
        <Route path="/admin/disco" element={<AdminDisco />} />
