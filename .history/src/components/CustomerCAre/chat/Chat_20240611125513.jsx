            ...
            <div>
                <div className="sm:block hidden bg-[#F3F3F3] pt-10 pb-20 pl-[223px] w-full h-full">
                    <div className=' ml-6'>
                        ...
                        <div className="bg-white w-[989px] mt-10 rounded-md grid-cols-9 grid">
                            ...
                            <div className='col-span-3 ml-20 p-2'>
                                <div className="flex my-8">
                                    <img src={chatuser} alt="" className='w-8 h-8'/>
                                    <p className='ml-2 break-words w-full'>testing@gmail.com</p>
                                </div>
                                <div className="flex my-8">
                                    <img src={chatuser} alt="" className='w-8 h-8'/>
                                    <p className='ml-2 break-words w-full'>testing@gmail.com</p>
                                ...
                                <div className="flex my-8">
                                    <img src={chatuser} alt="" className='w-8 h-8'/>
                                    <p className='ml-2 break-words w-full'>testingksdjkljsdkjjasdkjj@gmail.com</p>
                                </div>
                            </div>
