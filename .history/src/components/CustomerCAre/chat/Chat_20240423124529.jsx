            ...
            <div>
                    ...
                    <div className=' ml-6'>
                        ...
                        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-6 lg:mx-0 lg:max-w-none lg:grid-cols-2 mt-6 ">
                            <div>
                                ...
                                <div className='flex py-[9px] px-[16px] bg-white w-[420px] h-[64px] rounded-lg mt-8' key={index}>
                                    <div className='rounded-lg text-center pt-2 ml-2 font-semibold flex'>
                                    ...
                                    <div className='bg-white rounded-lg ml-10 text-center pt-2 text-green-500'>+ ₦{item.amount}</div>
                ...
                <div className="lg:hidden md:hidden bg-[#F3F3F3] w-full h-screen flex justify-center">
                    <div className='my-10 '>
                        ...
                        {transaction ?
                            (transaction.map((item, index) => (
                            <div className='flex pt-[18px] px-[16px] bg-white w-[328px] h-[70px] rounded-lg mt-8 mb-4' key={index}>
                                ...
                                <div className='bg-white rounded-lg h-[32px] text-center ml-10 pt-1 text-green-500'>+ ₦{item.amount}</div>
                            </div>))) : "No Transactions Yet"}
