...
const Chat = () => {
    ...
    const fetchMessages = (convo_id) => {
        ...
        const convo = { convo_id: currentConvoId };
                        ...
                        <div className="bg-white w-[989px] p-10 mt-10 rounded-md grid-cols-9 grid"> 
                            <div className="col-span-6 h-full">
                                ...
                                <>
                                    ...
                                    <p key={index} className='rounded-md p-2 bg-slate-50'>{msg.message}</p>
                            ...
                            <div className='col-span-3 ml-20 p-2 bg-gray-50'>
                                ...
                                {conversations.map((convo) => (
                                    <div key={convo.convo_id} className="flex my-8"
                                     onClick={() => fetchMessages(convo.convo_id)}>
                                        <img src={chatuser} alt="" className='w-8 h-8'/>
                                ...
                                <div className="flex my-8">
                                    <img src={chatuser} alt="" className='w-8 h-8'/>
                                    <p className='ml-2 break-words w-[150px] hover:text-secondary'>testing@gmail.com</p>
                                </div>
                                <div className="flex my-8">
                                    <img src={chatuser} alt="" className='w-8 h-8'/>
