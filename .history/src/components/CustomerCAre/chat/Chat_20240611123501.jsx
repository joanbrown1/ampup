            ...
            <div>
                <div className="sm:block hidden bg-[#F3F3F3] pt-10 pl-[223px] w-full h-full">
                    <div className=' ml-6'>
                        ...
                        <div className="bg-white w-[989px] p-10 mt-10 rounded-md grid-cols-9  ">
                            <div className="col-span-6">
                                <div className="flex my-2 rounded-sm p-2 bg-slate-50">
                                    <img src={chatuser} alt="" className='w-6 h-6'/>
                                    <p className='ml-2'>Something pretting confusing the user is asking about</p>
                                </div>
                                <div className="flex my-2">
                                    <p className=''>Something pretting confusing the user is asking about</p>
                                    <img src={chatuser} alt="" className='ml-2 w-6 h-6' />
                                </div>
                            </div>
                        </div>
                    </div>
