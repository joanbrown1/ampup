...
const Side = () => {
  ...
  return (
    <nav className="text-secondary w-side fixed top-0 p-4 pl-[37.46px] sm:block hidden bg-white h-screen shadow-2xl ">
      ...
      <ul className="font-medium text-sm ">
        ...
        <li>
          ...
          >
           {location.pathname === "/admin/changepassword" ?  <img src={discountwhite} className="mr-4 w-6 h-6"/> :  <img src={discount} className="mr-4 w-6 h-6"/>}
            Change Password
          </NavLink>
        </li>
        <hr className="w-[140px] my-2" />
