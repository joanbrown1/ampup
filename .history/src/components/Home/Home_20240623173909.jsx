...
const Home = () => {
  ...
  return (
    ...
    <div className='flex pt-20'>
          <div>
            <p className='pt-4 text-lg font-bold mr-1 ml-4'>Download App</p>
          </div>
          <div className="flex">
            <div className="rounded-full flex border-secondary border-2 px-4 justify-center items-center p-2 mx-2">
              <p className='text-lg font-bold'>Andriod</p>
              <img src={android} alt="android" className='w-8 h-8 ml-2'/>
            </div>
            <div className="rounded-full flex border-secondary border-2 px-4 justify-center items-center p-2">
              <p className='text-lg font-bold'>IOS</p>
              <img src={apple} alt="apple" className='w-8 h-8 ml-2'/>
            </div>
          </div>
