...
const Home = () => {
  ...
  return (
    ...
    <div className='flex pt-20 mx-4'>
          ...
          <div className="flex">
            <div className="rounded-full flex border-secondary border-2 px-4 justify-center items-center p-1 mx-2">
              <p className='text-lg font-bold'>Andriod</p>
              <img src={android} alt="android" className='w-8 h-8 ml-2'/>
            </div>
            <div className="rounded-full flex border-secondary border-2 px-4 justify-center items-center p-1">
              <p className='text-lg font-bold'>IOS</p>
              <img src={apple} alt="apple" className='w-8 h-8 ml-2'/>
            </div>
          </div>
