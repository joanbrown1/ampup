  ...
  return (
    ...
    <div className='footer lg:mx-5 mb-[25px]'>
        <div className='mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3 text-white pb-12'>
            ...
            <div className='col-span-1 mt-20 lg:ml-32 ml-8'>
                ...
                <div className="flex mt-4">
                    ...
                    <a href='mailto:support@powerplus.ng' className='font-light'>support@powerplus.ng</a>
                </div>

                <p className='font-bold mt-5'>Terms</p>
                <div className="flex mt-1">
                    <a href='https://powerplus.ng/privacypolicy' className='font-light '>Privacy Policy</a>
                </div>
                <div className="flex mt-1">
                    <a href='https://powerplus.ng/returnpolicy' className='font-light '>Refurn Policy</a>
                </div>
        ...
        <div className='flex justify-center items-center pb-4 px-8'>
            ...
            <p className='text-white font-thin '>Copyright 2023 | Power Plus Inc. All rights Reserved</p>
        </div>
    </div>
    </>
  )
