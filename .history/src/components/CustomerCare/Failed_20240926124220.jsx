                        ...
                        <div className='overflow-x-auto'>
                            <div>
                                <div className='flex text-black font-base font-semibold'>
                                    <p className=' my-4 w-fit mx-5'>Email:</p>
                                    <p className=' my-4 w-fit mx-5'>Date:</p>
                                    <p className=' my-4 w-fit mx-5'>Meter Number:</p>
                                    <p className=' my-4 w-fit mx-5'>Amount Paid:</p>
                                    <p className=' my-4 w-fit mx-5'>Token:</p>
                                    <p className=' my-4 w-fit mx-5'>Location:</p>
                                    <p className=' my-4 w-fit mx-5'> </p>
                                </div>
                            </div>
                                ...
                                <div className=''>
                                    {currentUsers.map((user, index) => (
                                        <div key={index} style={{ cursor: 'pointer' }}>
                                            <div className='flex'>
                                                <p className='my-4 w-fit mx-5'>{user.email}</p>
                                                <p className='my-4 w-fit mx-5'>{formatDate(user.date)}</p>
                                                <p className='my-4 w-fit mx-5'>{user.meternumber}</p>
                                                <p className='my-4 w-fit mx-5'>{user.amount}</p>
                                                <p className='my-4 w-fit mx-5'>{user.token}</p>
                                                <p className='my-4 w-fit mx-5'>{user.location}</p>
