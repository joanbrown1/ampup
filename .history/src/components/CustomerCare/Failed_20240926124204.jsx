                        ...
                        <div className='overflow-x-auto'>
                            <div>
                                <div className='flex text-black font-base font-semibold'>
                                    <p className=' my-4 w-fit'>Email:</p>
                                    <p className=' my-4 w-fit'>Date:</p>
                                    <p className=' my-4 w-fit'>Meter Number:</p>
                                    <p className=' my-4 w-fit'>Amount Paid:</p>
                                    <p className=' my-4 w-fit'>Token:</p>
                                    <p className=' my-4 w-fit'>Location:</p>
                                    <p className=' my-4 w-fit'> </p>
                                </div>
                            </div>
                                ...
                                <div className=''>
                                    {currentUsers.map((user, index) => (
                                        <div key={index} style={{ cursor: 'pointer' }}>
                                            <div className='flex'>
                                                <p className='my-4 w-fit'>{user.email}</p>
                                                <p className='my-4 w-fit'>{formatDate(user.date)}</p>
                                                <p className='my-4 w-fit'>{user.meternumber}</p>
                                                <p className='my-4 w-fit'>{user.amount}</p>
                                                <p className='my-4 w-fit'>{user.token}</p>
                                                <p className='my-4 w-fit'>{user.location}</p>
