                ...
                >
                    <div className="text-center">
                        ...
                        <>
                            ...
                            <button className='mb-20 bg-[#7B0323]  h-[45px] mt-5 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={(e) => initializePayment(e)}>
                            Buy
                            </button>
                        </> :
                        <>
                        ...
                        <button className='mb-20 bg-[#7B0323]  h-[45px] mt-10 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={() => setShow(true)}>
                        Confirm
                        </button>
                        </>:''}
                        {!custumer && !confirm ?
