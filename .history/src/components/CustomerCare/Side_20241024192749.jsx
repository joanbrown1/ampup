...
import failedwhite from "../../assets/failedwhite.png"
import disco from "../../assets/disco.png"
import discowhite from "../../assets/discowhite.png"
import announcements from "../../assets/announcements.png"
import announcementswhite from "../../assets/announcementswhite.png"
  ...
  return (
    <nav className="text-secondary w-side fixed top-0 p-4 pl-[37.46px] sm:block hidden bg-white h-screen shadow-2xl overflow-auto over">
      ...
      <ul className="font-medium text-sm ">
        <li>
          <NavLink
            to="https://dashboard.tawk.to/#/monitoring"
        ...
        <li>
          <NavLink
            to="/admin/failed"
            className={`p-2 mb-1 hover:bg-secondary hover:text-primary rounded-lg transition-all flex ${
              location.pathname === "/admin/failed" ? "bg-secondary text-white" : ""
            }`}
          >
           {location.pathname === "/admin/failed" ?  <img src={failedwhite} className="mr-4 w-6 h-6"/> :  <img src={failed} className="mr-4 w-6 h-6"/>}
            Failed Transactions
          </NavLink>
        </li>
        <hr className="w-[140px] my-2" />
        ...
        <li>
          <NavLink
            to="/admin/disco"
            className={`p-2 mb-1 hover:bg-secondary hover:text-primary rounded-lg transition-all flex ${
              location.pathname === "/admin/disco" ? "bg-secondary text-white" : ""
            }`}
          >
           {location.pathname === "/admin/disco" ?  <img src={discowhite} className="mr-4 w-6 h-6"/> :  <img src={disco} className="mr-4 w-6 h-6"/>}
            Disco
          </NavLink>
        </li>
        <hr className="w-[140px] my-2" />
        ...
        <li>
          <NavLink
            ...
            className={`p-2 mb-1 hover:bg-secondary hover:text-primary rounded-lg transition-all flex ${
              location.pathname === "/admin/announcements" ? "bg-secondary text-white" : ""
            }`}
          >
           {location.pathname === "/admin/announcements" ?  <img src={announcementswhite} className="mr-4 w-6 h-6"/> :  <img src={announcements} className="mr-4 w-6 h-6"/>}
            Annoucements
          </NavLink>
        </li>
        <hr className="w-[140px] my-2" />
