            ...
            <div className='lg:col-span-10'>
                <Modal show={openModal} size="md" onClose={() => setOpenModal(false)} popup>
                    ...
                    <div className="text-center">
                        ...
                        <>
                            ...
                            <button className='mb-20 bg-[#7B0323] w-fit h-[45px] mt-5 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={(e) => initializePayment(e)}>
                            Buy
                            </button>
                        </> :
                        <>
                        ...
                        <button className='mb-20 bg-[#7B0323] w-fit h-[45px] mt-10 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={() => setShow(true)}>
                        Confirm
                        </button>
                        </>:''}
                        {!custumer && !confirm ?
                        <button className='mb-10 bg-[#7B0323] w-fit h-[45px] mt-10 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={(e) => checkMeter(e)}>
                        Buy Power
                        </button>:""}
                        </form>
                ...
                <div className="sm:block hidden bg-[#F3F3F3] pt-10 w-full h-full pb-10">
                    <div className=' pl-6'>
                        ...
                        <div className='bg-white w-[350px] mt-10 rounded-2xl mx-4 p-5 border-gray-500 border-2 shadow-md'
