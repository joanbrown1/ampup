                            ...
                            data ?
                                ...
                                <>
                                {
                                    ...
                                    <>
                                        ...
                                        {!custumer && !confirm ?
                                            <button className='mb-10 bg-[#7B0323] w-[320px] h-[45px] mt-10 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={handleSubmit}>
                                            Continue
                                            </button> : ''
                                        }
                                        </form>
