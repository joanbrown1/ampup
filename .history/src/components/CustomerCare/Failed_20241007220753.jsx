                    ...
                    <div className="text-center">
                        ...
                        <>
                            <div className=' text-gray-700'>
                                ...
                                <hr className='w-[320px] my-8'/>
                                <p className='text-lg'>Total:</p>
                                <p className='text-lg mb-4 text-secondary'>{displayAmount}</p>
                            </div>
                            <button className='mb-20 bg-[#7B0323] w-[320px] h-[45px] mt-5 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={(e) => initializePayment(e)}>
                            Buy
                            </button>
                        </> :
                        <>
                        ...
                        <button className='mb-20 bg-[#7B0323] w-[320px] h-[45px] mt-10 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={() => setShow(true)}>
                        Confirm
                        </button>
                        </>:''}
                        {!custumer && !confirm ?
                        <button className='mb-10 bg-[#7B0323] w-[320px] h-[45px] mt-10 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={(e) => checkMeter(e)}>
                        Buy Power
                        </button>:""}
                        </form>
