            ...
            <div className='lg:col-span-10'>
                ...
                >
                    <div className="text-center">
                        ...
                        {!custumer && !confirm ?
                        <button className='mb-10 bg-[#7B0323]  h-[45px] mt-10 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={(e) => checkMeter(e)}>
                        Buy Power
                        </button>:""}
                        </form>
