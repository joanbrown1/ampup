                        ...
                        <div className='overflow-x-auto'>
                            <div>
                                <div className='flex text-black font-base font-semibold'>
                                    ...
                                    <p className=' my-4 min-w-[200px]'>Date:</p>
                                    <p className=' my-4 min-w-[200px]'>Meter Number:</p>
                                    <p className=' my-4 min-w-[200px]'>Amount Paid:</p>
                                    ...
                                    {currentUsers.map((user, index) => (
                                        <div key={index} style={{ cursor: 'pointer' }}>
                                            <div className='flex'>
                                                ...
                                                <p className='my-4 min-w-[200px]'>{formatDate(user.date)}</p>
                                                <p className='my-4 min-w-[200px]'>{user.meternumber}</p>
                                                <p className='my-4 min-w-[200px]'>{user.amount}</p>
