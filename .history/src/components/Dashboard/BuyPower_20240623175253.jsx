...
const BuyPower = () => {
  ...
  return (
    <>
        <div className='mb-[30px] grid grid-cols-10'>
            <div className='col-span-2'>
                <Sidebar/>
            </div>
            8<div className='col-span-8'>
                <div className="sm:block hidden bg-[#F3F3F3] pt-10 pl-[223px] w-full h-full pb-10">
                    <div className=' ml-6'>
                        <p className='text-lg font-medium mb-4'>Buy Electricity</p>
                        <div className='newbg h-[175px] pl-[87.61px] pt-[49px]'>
