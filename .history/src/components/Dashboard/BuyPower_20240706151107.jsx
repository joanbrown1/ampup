      ...
      const handleShare = () => {
        ...
        if (tokenn) {
            if (navigator.share) {
                ...
                navigator.share({
                  title: 'Share site',
                  text: `Token : ${tokenn} Recharge your electric meter with ease here! https://powerplus.ng`,
                ...
                const text = `Token : ${tokenn} Recharge your electric meter with ease here! https://powerplus.ng`;
                    ...
                    <div className='ml-[300px] mt-10'>
                        {
                            ...
                            <p className='text-seconday cursor-pointer italic underline' onClick={handleShare()}>Share Token with your contact.</p>
