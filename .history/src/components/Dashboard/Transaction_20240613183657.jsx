...
const Transaction = () => {
  ...
  const generatePDF = () => {
    if (containerRef.current) {
      console.log('Container ref:', containerRef.current); // Debugging line
      ...
      console.log('Container ref is null'); // Debugging line
    }
  };
                    ...
                    <div className='pb-20'>
                      <div className='text-center text-[#808080] w-[989px]' ref={containerRef}>
                        ...
                        <div className='my-[6px] mx-[10px] flex justify-between'>
                          ...
                          <button onClick={() => handleCopyToken(item.token)} className='ml-2 text-blue-500 underline'>Copy</button>
                        </div>
                        <hr />
                        <div className='my-[6px] mx-[10px] flex justify-between'>
                          <p>Service Charge:</p>
