    ...
    <div className='mb-[30px]'>
      ...
      <div>
        <div className="sm:block hidden bg-[#F3F3F3] pt-10 pl-[223px] w-full h-screen">
          <div className=' ml-6'>
            <p className='ml-[350px] font-medium text-xl'>Edit Phone Number</p>
            ...
            <Alert color="success" className='mb-10 w-[350px]'>
                <span className="font-medium">Done!</span> New Phone Number would reflect the next time you log in
            </Alert>: ""
            }
            {error ? 
        ...
        <div className="lg:hidden md:hidden bg-[#F3F3F3] w-full h-screen flex justify-center">
          <div className='my-10 '>
          <p className='text-center font-medium text-xl'>Edit Phone Number</p>
            <div className=''>
                <form className='mb-4 mt-10' onSubmit={handleSubmit}>
                <div className="w-[350px] mt-3">
                    <div className="relative">
