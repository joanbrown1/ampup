...
const BuyPower = () => {
    ...
    useEffect(() => {
      ...
      const checkMeter = async (e) =>{
        ...
        try {
            let headersList = {
                "api-key": "63ba3d3c61422c58f2a4fee1fa157852",
                "secret-key": "SK_210c5eb49d231bbd75c8489d7449e8cba7c52fa3b4a",
                "Content-Type": "application/json"
               }
        ...
        if(newMeter) {
                try {
                    ...
                    let res = await fetch("https://ampupserver.onrender.com/meter", { 
                        method: "POST",
                        body: body,
                        headers: {
                        "Content-Type": "application/json"
                    ...
                    <div className='ml-[300px] mt-10'>
                        ...
                        <div className="w-[350px] mt-2">
                            <div className='grid grid-cols-2 gap-4'>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'ikeja-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('ikeja-electric')}
                                >
                                    <img src={ikedc} className='w-[75px]'/>
                                    <p className='text-center text-black text-sm'>Ikeja</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'eko-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('eko-electric')}
                                >
                                    <img src={ekedc} className='w-[75px] ml-5 mb-5'/>
                                    <p className='text-center text-black text-sm'>EKEDC</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'kano-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('kano-electric')}
                                >
                                    <img src={kedco} className='w-[75px] h-[60px] ml-5'/>
                                    <p className='text-center text-black text-sm'>KEDCO</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'portharcourt-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('portharcourt-electric')}
                                >
                                    <img src={phedc} className='mb-3'/>
                                    <p className='text-center text-black text-sm'>PHEN</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'jos-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('jos-electric')}
                                >
                                    <img src={jed} className='w-[75px] ml-5'/>
                                    <p className='text-center text-black text-sm'>JED</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'ibadan-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('ibadan-electric')}
                                >
                                    <img src={ibedc} className='w-[75px] ml-3 mb-3'/>
                                    <p className='text-center text-black text-sm'>IBEDC</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'kaduna-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('kaduna-electric')}
                                >
                                    <img src={kaedco} className='w-[75px] ml-3 my-3'/>
                                    <p className='text-center text-black text-sm'>KAEDCO</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'abuja-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('abuja-electric')}
                                >
                                    <img src={aedc} className='w-[75px] my-3 ml-3'/>
                                    <p className='text-center text-black text-sm'>AEDC</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'enugu-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('enugu-electric')}
                                >
                                    <img src={eedc} className='w-[75px] my-2 ml-3'/>
                                    <p className='text-center text-black text-sm'>EEDC</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'benin-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('benin-electric')}
                                >
                                    <img src={bedc} className='w-[75px] my-3 ml-3'/>
                                    <p className='text-center text-black text-sm'>BEDC</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'aba-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('aba-electric')}
                                >
                                    <img src={apl} className='w-[75px] h-[60px] ml-5'/>
                                    <p className='text-center text-black text-sm'>ABA</p>
                                </div>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'yola-electric' ? 'border-secondary' : 'border-white'}`} 
                                    onClick={() => handleLocation('yola-electric')}
                                >
                                    <img src={yedc} className='w-[75px] h-[60px] ml-5 '/>
                                    <p className='text-center text-black text-sm'>YEDC</p>
                                </div>
                            </div>
                        </div>
                        <div className="w-[350px] mt-2">
