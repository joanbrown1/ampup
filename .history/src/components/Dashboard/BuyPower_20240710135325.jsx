                        ...
                        {newMeter ? (
                            ...
                            <div className='w-[350px]'>
                                <div className={`py-2 pl-5 pr-3 block w-full border-2 rounded-xl focus:outline-none hover:border-[#7B0323] ${formData.location ? 'border-gray-300' : 'border-[#7B0323]'}`}>
                                    ...
                                    <p className='pt-2 font-mono font-bold border-2 rounded-lg text-center px-2 ml-2 h-[50px] text-secondary mt-2 cursor-pointer ' onClick={() => setNewMeter(true)}>Add new Meter</p>
                                </div>
                            </div>
                        )}
