                ...
                <div className='ml-6'>
                    ...
                    <div className='ml-[300px] mt-10'>
                        ...
                        {newMeter ? (
                            ...
                            <div className='w-[350px] mt-2'>
                                <div className="py-1 pl-5 pr-3 w-full bg-white border-2 rounded-xl border-gray-300 focus:outline-none focus:border-[#7B0323] hover:border-[#7B0323] flex">
                                    <div className=" mt-2">
                                        <div className="relative">
                                            <select
                                                id="meter_number"
                                                ...
                                                onChange={handleChange}
                                                style={{ fontSize: '1rem', height: '70px' }}
                                                className="py-q pl-5 pr-3 block w-full border-2 rounded-xl border-gray-300 focus:outline-none focus:border-[#7B0323] hover:border-[#7B0323]"
                                            >
