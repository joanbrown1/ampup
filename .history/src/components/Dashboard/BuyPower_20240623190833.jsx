      ...
      const handleShare = (token) => {
        if (token) {
            if (navigator.share) {
                ...
                navigator.share({
                  title: 'Share site',
                  text: `Token : ${token} Recharge your electric meter with ease here! https://powerplus.ng`,
                ...
                const text = `Token : ${token} Recharge your electric meter with ease here! https://powerplus.ng`;
            ...
            if (navigator.share) {
                ...
                navigator.share({
                  title: 'Share site',
                  text: 'Recharge your electric meter with ease here! https://powerplus.ng',
                  // url: 'https://powerplus.ng',
                }).then(() => {
                  console.log('Successfully shared');
                }).catch(error => {
                ...
                // Fallback for browsers that do not support Web Share API
                const title = 'Share site';
                const text = 'Recharge your electric meter with ease here! https://powerplus.ng';
                // const url = 'https://powerplus.ng';
                        ...
                        <div className='ml-[300px] mt-10'>
                            {
                                ...
                                <p className='text-seconday cursor-pointer italic underline' onClick={handleShare(data.token || data.Token)}>Share Token with your contact.</p>
                ...
                <div className="lg:hidden md:hidden bg-[#F3F3F3] w-full h-full flex justify-center ">
                    <div className='my-10'>
                        ...
                        </div>
                        {
                                data ?
                                <>
                                <div className='flex border-2 border-green-300 bg-green-200 p-5 w-[328px] italic rounded-lg text-green-500 text-lg my-2 mt-10'>
                                    <p>Token: {data.token || data.Token}</p>
                                    <img src={copy} alt='copy' className='w-5 h-5 mt-1 ml-3 cursor-pointer' onClick={handleCopyToken}/>
                                </div>
                                <p className='text-seconday cursor-pointer italic underline' onClick={handleShare}>Share Power Plus with your contacts</p>
