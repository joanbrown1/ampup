                    ...
                    <div className='ml-[300px] mt-10'>
                        ...
                        <div className="w-[350px] mt-2">
                            <div className='grid grid-cols-2 gap-4'>
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'ikeja-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'eko-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'kano-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'portharcourt-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'jos-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'ibadan-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'kaduna-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'abuja-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'enugu-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'benin-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'aba-electric' ? 'border-secondary' : ''}`} 
                                ...
                                <div 
                                    className={`bg-white w-[150px] rounded-md px-5 py-3 h-[100px] cursor-pointer border-2 border-white hover:border-secondary ${formData.location === 'yola-electric' ? 'border-secondary' : ''}`} 
