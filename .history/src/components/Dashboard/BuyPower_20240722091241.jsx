            ...
            <div className="lg:hidden md:hidden bg-[#F3F3F3] w-full h-full flex justify-center ">
                <div className='my-10 pb-10'>
                    ...
                    </div>
                    {
                        ...
                        {!custumer && !confirm ?
                        <button className='mb-5 bg-[#7B0323] w-[350px] h-[60px] mt-20 hover:bg-white hover:text-black p-2 border-[#7B0323] border-2 rounded-lg text-white text-lg' onClick={(e) => checkMeter(e)}>
                        Buy Power
                        </button>:""}
                        </form>
