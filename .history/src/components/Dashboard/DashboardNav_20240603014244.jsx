...
const DashboardNav = () => {
  ...
  return (
    ...
    <div className='bg-white p-2 h-[75px] lg:ml-[223px] md:ml-[223px] ml-4 flex items-center mt-[45px]'>
        ...
        <div className="lg:hidden md:hidden ml-[140px] rounded-md p-2 text-gray-400 hover:bg-[#4E2391] hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
