...
const options = [
    { value: 'ikeja-electric', label: 'IKEDC - Ikeja Electric', img: 'path/to/ikedc.jpg' },
    { value: 'eko-electric', label: 'EKEDC - Eko Electric', img: 'path/to/ekedc.jpg' },
    { value: 'kano-electric', label: 'KEDCO - Kano Electric', img: 'path/to/kedco.jpg' },
