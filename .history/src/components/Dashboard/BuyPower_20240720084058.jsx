                    ...
                    <div className='ml-[300px] mt-10'>
                        ...
                        <div className="w-[350px] mt-2">
                            <div className="relative">
                                ...
                                onChange={handleChange}
                                style={{ fontSize: '1rem', height: '70px' }}
                                className={`py-2 pl-5 pr-3 block w-full border-2 rounded-xl focus:outline-none hover:border-[#7B0323] text-gray-100 ${formData.amount ? 'border-gray-300' : 'border-[#7B0323]'}`}
                                />
                            </div>
                        </div>
