...
const BuyPower = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      const initializePayment = async (e) => {
        ...
        const secretKey = "sk_live_e420981e0e63e685dca63fbecdc484beec33c5bd"; // Move the secret key to the .env file
        ...
        try {
          ...
          // Once the popup is done, call the verify transaction API
          paystackPopup.onComplete(async () => {
            try {
