...
const BuyPower = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      const initializePayment = async (e) => {
        ...
        const secretKey = "sk_live_e420981e0e63e685dca63fbecdc484beec33c5bd"; // Replace with your actual Paystack secret key
        ...
        try {
          ...
          console.log(result.data.access_code);
    ...
    const tpl = powerd.content ? parseFloat(powerd.content.transactions.commission) + pl : pl;
    // console.log(powerd);
