...
const BuyPower = () => {
    ...
    useEffect(() => {
      ...
      const checkMeter = async (e) =>{
        ...
        if (formData.amount < 600) newErrors.amount = "Amount must be more than 600.";
    ...
    const Power = async () => {
        ...
        try {
            ...
            if (data.code != "000"){
                setSearch("We're experiencing an issue generating your token. Please wait a few minutes and check your transaction history again. If the delay persists, feel free to reach out to us via the in-app chat below");
            }else {
             setPowerd(data);
            }
            ...
            <div className="lg:hidden md:hidden bg-[#F3F3F3] w-full h-full flex justify-center ">
                <div className='my-10 pb-10'>
                    ...
                    </div>
                    {
                        ...
                        {fill ? 
                    <Alert color="failure" className='mb-10 w-[350px]'>
                        <span className="font-medium">We're experiencing an issue generating your token. Please wait a few minutes and check your transaction history again. If the delay persists, feel free to reach out to us via the in-app chat below</span> {fill}
                    </Alert>: ""
                    }
                    <Alert color="failure" className='mb-10 w-[350px]'>
                        <span className="font-medium">We're experiencing an issue generating your token. Please wait a few minutes and check your transaction history again. If the delay persists, feel free to reach out to us via the in-app chat below</span> {fill}
