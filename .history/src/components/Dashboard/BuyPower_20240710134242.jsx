                ...
                <div className='ml-6'>
                    ...
                    <div className='ml-[300px] mt-10'>
                        ...
                        {newMeter ? (
                            ...
                            <div className='w-[350px] pb-1'>
                                <div className="py-2 pl-5 pr-3 bg-white border-2 rounded-xl border-gray-300 focus:outline-none focus:border-[#7B0323] hover:border-[#7B0323] flex">
                                    <div className=" mt-2">
                                        <div className="relative">
                                            <select
                                                id="meter_number"
                                                ...
                                                className=" pl-5 block w-full border-2 rounded-xl border-gray-300 focus:outline-none focus:border-[#7B0323] hover:border-[#7B0323]"
                                            >
                                    ...
                                    <p className='font-mono font-bold border-2 rounded-lg text-center px-2 ml-2 h-[50px] text-secondary mt-2 cursor-pointer ' onClick={() => setNewMeter(true)}>Add new Meter</p>
                                </div>
                            </div>
                        )}
